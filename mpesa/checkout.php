...
.button button {
  ...
  .button button i {
   ...
   <div class="container">
    ...
    <div class="price">
        <h1>Welcome to Maweni Sec School !,Now pay for Son's fee</h1>
    </div>
    ...
    <p style="color:#8F92C3;line-height:1.7;margin-top:5rem;">Copyright 2023 | All Rights Reserved | Maweni Sec School</p>
</div>
   </body>
</html>
