...
?>      
      ...
      <ul class="sidebar-menu">
        ...
        <li>
          <a href="grade.php">
            <i class="fa fa-database"></i> <span>Form</span>
          </a>
        </li>
        <li>
          <a href="subject.php">
        ...
        <li>
          <a href="subject_routing.php">
            <i class="fa fa-th"></i> <span>Tuition Subject Routing</span>
          </a>
        </li>
        <li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
          	<li><a href="../SchoolFeesMgSystem-PHP"></i> Accounting Module</a></li>
           <li><a href="my_friends.php"><i class="fa fa-circle-o"></i></a>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="../libsystem"><i class="fa fa-circle-o"></i> My library</a></li>
            <li><a href="../libsystem/admin
            "><i class="fa fa-circle-o"></i>Librarian Panel </a></li>
          </ul>
        </li>
      ...
      <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="../ExamsCou/adminpanel"><i class="fa fa-circle-o"></i>Examiner</a></li>
            <li><a href="../ExamsCou"><i class="fa fa-circle-o"></i>Examinee </a></li>
          </ul>
        </li>
