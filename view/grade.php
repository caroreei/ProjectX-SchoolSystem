                	...
                	<form role="form" action="../index.php" method="post" id="form1">                    
                  		<div class="box-body">
                            ...
                            <div class="form-group" id="divAdmissionFee">
                      			<label for="">Admission Fee(Ksh)</label>
                             ...
                             <div class="form-group" id="divHallCharge">
                      			<label for="">Minimum Admission Fee To be paid(%)</label>
			...
			<div class="col-md-7">
            	<div class="box">
                	<div class="box-header">
                  		<h3 class="box-title">All Form</h3>
                	</div><!-- /.box-header -->
                	<div class="box-body table-responsive">
                		...
                		<table id="example1" class="table table-bordered table-striped">
                    		<thead>
                        		<th>ID</th>
                            	<th>Form</th>
                                <th>Admission Fee(Ksh)</th>
                                <th>Minimum Admission Fee To be paid(%)</th>
                            	<th>Action</th>
                        	</thead>
                        	<tbody>
<?php
           			...
           			<div class="col-md-6">
                		<div class="panel">
        					<div class="panel-heading bg-orange">              
        						<button type="button" class="close" data-dismiss="modal" aria-hidden="true"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></button>
          						<h4 class="modal-title custom_align" id="Heading">Edit Form</h4>
   							</div>
                            <div class="panel-body"> <!-- Start of modal body--> 
