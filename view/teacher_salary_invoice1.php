            			...
            			<div class="panel-body"><!--panel-body -->
                        	<div class="row " id="msk12345">
                                ...
                                <div class="col-xs-5 class-name">
                                	<h2>Maweni Sec School</h2>
                                	<div class="class-address">
                                    Home of Excellent,<br>
                                    Strive to Excell
                                    </div>
                                </div>
                                <div class="col-xs-4 class-email text-right ">
                                    	Email: Maweni.ms4@gmail.com<br>
...
?>                                    
                             ...
                             <table class="table table-bordered">
                                <thead>
                                    ...
                                    <th class="col-md-2">Amount(Ksh)</th>
                            ...
                            <div class="row">
                                <div class="col-xs-1 pdetail1">
                                      <strong>
                                        <span id="spanTotal1">Ksh<?php echo $total_salary; ?></span> <br>
                                        <span id="spanAdvance1">Ksh<?php echo $advance1; ?></span> <br>
										<span id="spanBalance1">Ksh<?php echo $balance; ?></span> <br>
                                        <span id="spanPaid1">Ksh<?php echo $paid; ?></span> <br>
                                      </strong>
  								</div>
